...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NGrams.qualified'
        db.delete_column(u'ngramengine_ngrams', 'qualified')

        # Adding field 'NGrams.active'
        db.add_column(u'ngramengine_ngrams', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NGrams.qualified'
        db.add_column(u'ngramengine_ngrams', 'qualified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'NGrams.active'
        db.delete_column(u'ngramengine_ngrams', 'active')
    ...
    models = {
        ...
        u'ngramengine.attributes': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'power': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attributes'", 'to': u"orm['ngramengine.NGrams']"}),
            't_rated': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
        ...
        u'ngramengine.examples': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'power': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'examples'", 'to': u"orm['ngramengine.NGrams']"}),
            't_rated': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
