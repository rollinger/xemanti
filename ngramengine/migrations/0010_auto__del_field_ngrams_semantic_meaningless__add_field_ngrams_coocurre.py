...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NGrams.semantic_meaningless'
        db.delete_column(u'ngramengine_ngrams', 'semantic_meaningless')

        # Adding field 'NGrams.coocurrence_relevancy'
        db.add_column(u'ngramengine_ngrams', 'coocurrence_relevancy',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NGrams.semantic_meaningless'
        db.add_column(u'ngramengine_ngrams', 'semantic_meaningless',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'NGrams.coocurrence_relevancy'
        db.delete_column(u'ngramengine_ngrams', 'coocurrence_relevancy')
