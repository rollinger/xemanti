...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SemanticDifferential.e_sum'
        db.add_column(u'ngramengine_semanticdifferential', 'e_sum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SemanticDifferential.e_sum'
        db.delete_column(u'ngramengine_semanticdifferential', 'e_sum')
