...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartOfSpeech.indicates_semantic_meaninglessness'
        db.delete_column('ngramengine_partofspeech', 'indicates_semantic_meaninglessness')

        # Adding field 'PartOfSpeech.semantic_meaningless'
        db.add_column('ngramengine_partofspeech', 'semantic_meaningless',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PartOfSpeech.indicates_semantic_meaninglessness'
        db.add_column('ngramengine_partofspeech', 'indicates_semantic_meaninglessness',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PartOfSpeech.semantic_meaningless'
        db.delete_column('ngramengine_partofspeech', 'semantic_meaningless')
