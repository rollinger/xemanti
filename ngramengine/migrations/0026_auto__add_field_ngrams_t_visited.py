...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NGrams.t_visited'
        db.add_column(u'ngramengine_ngrams', 't_visited',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NGrams.t_visited'
        db.delete_column(u'ngramengine_ngrams', 't_visited')
