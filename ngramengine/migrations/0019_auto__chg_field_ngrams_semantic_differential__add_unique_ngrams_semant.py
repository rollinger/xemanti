...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NGrams.semantic_differential'
        db.alter_column(u'ngramengine_ngrams', 'semantic_differential_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ngramengine.SemanticDifferential'], unique=True, null=True))
        # Adding unique constraint on 'NGrams', fields ['semantic_differential']
        db.create_unique(u'ngramengine_ngrams', ['semantic_differential_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NGrams', fields ['semantic_differential']
        db.delete_unique(u'ngramengine_ngrams', ['semantic_differential_id'])


        # Changing field 'NGrams.semantic_differential'
        db.alter_column(u'ngramengine_ngrams', 'semantic_differential_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngramengine.SemanticDifferential'], null=True))
    ...
    models = {
        ...
        u'ngramengine.ngrams': {
            ...
            'semantic_differential': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ngramengine.SemanticDifferential']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'ngramengine.semanticdifferential': {
            ...
            'activity': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '3'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'evaluation': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'potency': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '3'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
