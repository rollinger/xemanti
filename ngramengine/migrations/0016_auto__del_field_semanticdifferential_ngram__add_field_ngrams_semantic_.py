...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SemanticDifferential.ngram'
        db.delete_column(u'ngramengine_semanticdifferential', 'ngram_id')

        # Adding field 'NGrams.semantic_differential'
        db.add_column(u'ngramengine_ngrams', 'semantic_differential',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngramengine.SemanticDifferential'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SemanticDifferential.ngram'
        db.add_column(u'ngramengine_semanticdifferential', 'ngram',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='semantic_differential', to=orm['ngramengine.NGrams']),
                      keep_default=False)

        # Deleting field 'NGrams.semantic_differential'
        db.delete_column(u'ngramengine_ngrams', 'semantic_differential_id')
    ...
    models = {
        ...
        u'ngramengine.ngrams': {
            ...
            'semantic_differential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngramengine.SemanticDifferential']", 'null': 'True', 'blank': 'True'}),
