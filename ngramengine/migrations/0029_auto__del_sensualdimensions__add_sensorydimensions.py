...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SensualDimensions'
        db.delete_table(u'ngramengine_sensualdimensions')

        # Adding model 'SensoryDimensions'
        db.create_table(u'ngramengine_sensorydimensions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ngram', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ngramengine.NGrams'], unique=True, null=True, blank=True)),
            ('visual', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('auditory', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('cognition', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('kinesthetic', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('olfactory', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('gustatory', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('t_rated', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('v_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('a_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('c_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('k_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('o_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('g_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'ngramengine', ['SensoryDimensions'])


    def backwards(self, orm):
        # Adding model 'SensualDimensions'
        db.create_table(u'ngramengine_sensualdimensions', (
            ('visual', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('k_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('v_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('o_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'ngramengine', ['SensualDimensions'])

        # Deleting model 'SensoryDimensions'
        db.delete_table(u'ngramengine_sensorydimensions')
    ...
    models = {
        ...
        u'ngramengine.sensorydimensions': {
            'Meta': {'object_name': 'SensoryDimensions'},
            'a_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'auditory': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'c_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'cognition': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'g_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'gustatory': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'k_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'kinesthetic': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ngram': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ngramengine.NGrams']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'o_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'olfactory': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            't_rated': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'v_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'visual': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        },
