...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SemanticDifferential'
        db.create_table(u'ngramengine_semanticdifferential', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ngram', self.gf('django.db.models.fields.related.ForeignKey')(related_name='semantic_differential', to=orm['ngramengine.NGrams'])),
            ('evaluation', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=4, decimal_places=3)),
            ('potency', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=4, decimal_places=3)),
            ('activity', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=4, decimal_places=3)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'ngramengine', ['SemanticDifferential'])


    def backwards(self, orm):
        # Deleting model 'SemanticDifferential'
        db.delete_table(u'ngramengine_semanticdifferential')
    ...
    models = {
        ...
        u'ngramengine.semanticdifferential': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ngram': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'semantic_differential'", 'to': u"orm['ngramengine.NGrams']"}),
