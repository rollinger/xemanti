...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ngramengine_examples', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='example', to=orm['ngramengine.NGrams'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='example_of', to=orm['ngramengine.NGrams'])),
        ...
        db.send_create_signal(u'ngramengine', ['Examples'])

        # Adding model 'Attributes'
        db.create_table(u'ngramengine_attributes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attribute', to=orm['ngramengine.NGrams'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attribute_of', to=orm['ngramengine.NGrams'])),
            ('t_rated', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('power', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'ngramengine', ['Attributes'])


    def backwards(self, orm):
        # Deleting model 'Examples'
        db.delete_table(u'ngramengine_examples')

        # Deleting model 'Attributes'
        db.delete_table(u'ngramengine_attributes')
    ...
    models = {
        ...
        u'ngramengine.attributes': {
            'Meta': {'object_name': 'Attributes'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'power': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attribute'", 'to': u"orm['ngramengine.NGrams']"}),
            't_rated': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attribute_of'", 'to': u"orm['ngramengine.NGrams']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'ngramengine.examples': {
            'Meta': {'object_name': 'Examples'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'power': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'example'", 'to': u"orm['ngramengine.NGrams']"}),
            't_rated': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'example_of'", 'to': u"orm['ngramengine.NGrams']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'ngramengine.genus': {
