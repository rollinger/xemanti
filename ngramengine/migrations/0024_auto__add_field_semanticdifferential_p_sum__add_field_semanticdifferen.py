...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SemanticDifferential.p_sum'
        db.add_column(u'ngramengine_semanticdifferential', 'p_sum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SemanticDifferential.a_sum'
        db.add_column(u'ngramengine_semanticdifferential', 'a_sum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SemanticDifferential.p_sum'
        db.delete_column(u'ngramengine_semanticdifferential', 'p_sum')

        # Deleting field 'SemanticDifferential.a_sum'
        db.delete_column(u'ngramengine_semanticdifferential', 'a_sum')
    ...
    models = {
        ...
        u'ngramengine.semanticdifferential': {
            ...
            'a_sum': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'activity': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'e_sum': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'p_sum': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
