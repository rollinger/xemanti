...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SemanticDifferential.t_rated'
        db.add_column(u'ngramengine_semanticdifferential', 't_rated',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SemanticDifferential.t_rated'
        db.delete_column(u'ngramengine_semanticdifferential', 't_rated')
