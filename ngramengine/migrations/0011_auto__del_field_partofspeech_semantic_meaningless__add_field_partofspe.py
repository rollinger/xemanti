...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'ngramengine_partofspeech', 'semantic_meaningless')

        # Adding field 'PartOfSpeech.coocurrence_relevancy'
        db.add_column(u'ngramengine_partofspeech', 'coocurrence_relevancy',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ngramengine_partofspeech', 'semantic_meaningless',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PartOfSpeech.coocurrence_relevancy'
        db.delete_column(u'ngramengine_partofspeech', 'coocurrence_relevancy')
