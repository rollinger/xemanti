...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SemanticDifferential.p_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'p_sum', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SemanticDifferential.a_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'a_sum', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SemanticDifferential.e_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'e_sum', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'SemanticDifferential.p_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'p_sum', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SemanticDifferential.a_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'a_sum', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SemanticDifferential.e_sum'
        db.alter_column(u'ngramengine_semanticdifferential', 'e_sum', self.gf('django.db.models.fields.PositiveIntegerField')())
